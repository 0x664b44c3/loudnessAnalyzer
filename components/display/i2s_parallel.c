...
void i2s_parallel_setup(i2s_dev_t *dev, const i2s_parallel_config_t *cfg) {
    ...
    //this does weird shit if set to 1, like half the bits are repeated, others aint,
    //TODO: look into this, it's what stands between us and actual double buffered display
    ...
    //TODO: something's funky about this calculation, need to look into it at some later point
